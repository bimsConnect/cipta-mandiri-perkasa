...
import { approveTestimonialAction, rejectTestimonialAction } from "@/app/actions/testimonial-client-actions"
        ...
        >
          <div className="flex justify-between items-start mb-2">
            ...
            <div className="flex space-x-2">
              <Button size="sm" variant="outline" className="h-8 w-8 p-0" onClick={() => handleApprove(testimonial.id)}>
                <Check className="h-4 w-4 text-green-500" />
                <span className="sr-only">Approve</span>
              </Button>
              <Button size="sm" variant="outline" className="h-8 w-8 p-0" onClick={() => handleReject(testimonial.id)}>
